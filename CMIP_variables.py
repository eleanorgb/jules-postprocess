...
#               "outVar":[0.inputVars, 1.longName, 2.scale, 3.units, 4.outprofile, 5.func, 6.CMIPprofileName]
    var_dict = {
        ...
        "prra":          ["rainfall", "rainfall rate", None, "kg/m2/s", "precip", None, "Amon"],
        "prsn":          ["snowfall", "snowfall rate", None, "kg/m2/s", "precip", None, "Amon"],
        ...
        "evspsbl":       [["esoil_gb", "ei_gb"], "Evaporation Including Sublimation and Transpiration", None, 'kg m-2 s-1', "gen_mon_gb", "sum_func", "Amon"],
         "sbl":       ["ei_gb", "Sublimation", None, 'kg m-2 s-1', "snow", None, "LImon"],
         "snm":       ["snow_melt_gb", "Snow melt", None, 'kg m-2 s-1', "snow", None, "LImon"],
        # gen_mon_pft - MONTHLY
