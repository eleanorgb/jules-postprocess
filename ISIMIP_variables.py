...
#############"outVar":[0.inputVars, 1.longName, 2.scale, 3.units, 4.outprofile, 5.func]
    var_dict = {
        ...
        "ra":             ["resp_p_gb", "Carbon Mass Flux into Atmosphere due to Autotrophic (plant) Respiration on Land", None, "kg m-2 s-1", "ilamb", None],
        "rh":             ["resp_s_to_atmos_gb", "Carbon Mass Flux into Atmosphere due to Heterotrophic Respiration on Land", 1.0/(86400.0*360.0), "kg m-2 s-1", "ilamb", None],
        ...
        "ecoatmflux":     [["npp_gb", "resp_s_to_atmos_gb", "harvest_gb", "WP_fast_out", "WP_med_out", "WP_slow_out"], "Carbon Mass Flux out of Atmosphere due to Net biome Production on Land (NBP)", None, "kg m-2 s-1", "ilamb", "nbp_func"],
        "ecoatmflux_nlim":[["npp_n_gb", "resp_s_to_atmos_gb", "harvest_gb", "WP_fast_out", "WP_med_out", "WP_slow_out"], "Carbon Mass Flux out of Atmosphere due to Net biome Production on Land (NBP) Nitrogen limitied", None, "kg m-2 s-1", "ilamb", "nbp_func"],
