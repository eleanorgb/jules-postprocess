...
#               "outVar":[0.inputVars, 1.longName, 2.scale, 3.units, 4.outprofile, 5.func, 6.CMIPprofileName]
    var_dict = {
        ...
        #"npp_nlim_annual":         ["npp_n_gb", "Net Primary Production on Land as Carbon Mass Flux", 1.0/(86400.0*360.0), "kg/m2/s", "Annual", None, None],
        ...
        #"npp_annual":              ["npp_gb", "Carbon Mass Flux out of Atmosphere due to Net Primary Production on Land", None, "kg m-2 s-1", "Annual", None],
